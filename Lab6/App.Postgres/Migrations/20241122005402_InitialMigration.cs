    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CustomerId = table.Column<int>(type: "integer", nullable: false),
                    DateFirstPurchase = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DateLastPurchase = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<int>(type: "integer", nullable: false),
                    AssetTypeCode = table.Column<int>(type: "integer", nullable: false),
                    DateAssetAcquired = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<int>(type: "integer", nullable: false),
                    OutcomeStatusCode = table.Column<int>(type: "integer", nullable: false),
                    ContactDatetime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateDiscontinued = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerId = table.Column<int>(type: "integer", nullable: false),
                    SpecialOfferId = table.Column<int>(type: "integer", nullable: false),
                    DateOfferAccepted = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
